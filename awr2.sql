...
col avgwt       format 99999990.00         heading "Avgwt|(ms)"
col pctdbt      format 99990              heading "DB Time|%"
col aas         format 99990.0            heading "A|A|S"
col wait_class  format a15              heading "Wait Class"


select snap_id, TO_CHAR(tm,'MM/DD/YY HH24:MI') tm, inst, dur, event, event_rank, waits, time, avgwt, pctdbt, aas, wait_class
from 
